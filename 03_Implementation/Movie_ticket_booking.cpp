    ...
    do
{
	...
	{
	printf("  \n\n\n       WELCOME TO OUR BOOKING SYSTEM !!!! LOGIN SUCCESSFUL");
	...
	if (a>2)
	{
		printf("\nSorry you have entered  wrong username and password for four times!!!");
...
void book_ticket()
{
 struct book b;
	...
	printf("\n For Booking ticket (Enter Movie Code First Letter of Movie)\n");
	printf("\n Enter movie code :");
	scanf("%s",movie_code);
